...
{
    public class FloatingTextBlock : INotifyPropertyChanged
    {
        ...
        {
            UpMargin = r.Next(0, (int)Window.Current.Bounds.Height - MARGIN_OFFSET);
            LeftMargin = r.Next(0, (int)Window.Current.Bounds.Width - MARGIN_OFFSET);
